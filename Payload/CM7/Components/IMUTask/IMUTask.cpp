...
//	initialize low-level drivers
	...
	binoo.readLinearAccel(xAccel, yAccel, zAccel);
	SOAR_PRINT("Accel [%f,%f,%f]", xAccel, yAccel, zAccel);
...
void IMUTask::sendLinData(LSM6DSO& unit)
{
	...
	SOAR_PRINT("Accel [%f, %f, %f]", dataRead.xAccel, dataRead.yAccel, dataRead.zAccel);
